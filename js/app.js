...
function sumArray(sumArr) { //eslint-disable-line
    let e = sum(testArray[0], testArray[1])[0];
    let n = sum(e, testArray[2])[0];
    return [n, `${testArray[0]}, ${testArray[1]}, ${testArray[2]} was passed in as an array of numbers, and ${n} is their sum.`];
}
